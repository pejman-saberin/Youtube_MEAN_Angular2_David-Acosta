...
module.exports=(router)=>{
  /* ===============================================================
   ...
   router.get('/allBlogs',(req,res)=>{
     ...
     Blog.find({}, (err,blogs)=>{
       if(err){
         res.jason({seccuss:false, message:err});
       }else {
         if(!blogs){
           res.json({seccuss:false, message: 'No blogs found'});
         }else{
                ...
                if (!user) {
                  ...
                  if (user.username === blog.createdBy) {
                    ...
                    if (blog.likedBy.includes(user.username)) {
                      ...
                      // Check if user who liked post has previously disliked a post (this is an array of the users who already liked the post)
                      if (blog.dislikedBy.includes(user.username)) {
                        ...
                        blog.dislikedBy.splice(arrayIndex, 1); // Remove user from array (1 means remove 1 element)
